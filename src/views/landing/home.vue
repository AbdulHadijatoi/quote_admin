...
<template>
  ...
  <v-row class="bg-lightprimary pa-4" style="background: linear-gradient(to right, navy, transparent), url('/front_bg.jpeg') no-repeat center center fixed; background-size: cover;">
